...
namespace sensors {
    ...
    */
    ...
    export class APDS9960 {
         ...
         */
        //% blockId=gesture_read block="读取手势值|%strip" group="手势传感器"
        //% subcategory="传感器"
        //% weight=80 blockGap=8
        //% advanced=true
        read(): number {
     ...
     * 使用手势传感器前，先进行初始化。
     */
    //% blockId="gesture_init" block="初始化手势传感器 " group="手势传感器"
    //% subcategory="传感器"
    //% weight=80 blockGap=8
     ...
     */
    //% blockId="gesture_listener_block" block="检测手势|%gesture" group="手势传感器"
    //% subcategory="传感器"
    //% weight=80 blockGap=8
